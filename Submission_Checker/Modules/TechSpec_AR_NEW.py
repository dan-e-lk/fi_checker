...
# Lyr acronym            name                           mandatory fields                                            Data Type   Tech Spec       Tech Spec URL
    ...
    "AGG":  ["Forestry Aggregate Pits",                 ['PITID','REHABREQ','REHAB','PITCLOSE','TONNES'],           'point',    '4.3.18',       R.findPDF('FIM_AR_TechSpec_2018.pdf#page=116')],
    "EST":  ["Establishment Assessment",                ['ARDSTGRP','SILVSYS','AGEEST','YRDEP','DSTBFU','SGR',
                                                            'TARGETFU','TARGETYD','ESTIND','ESTFU','ESTYIELD',
                                                            'SPCOMP','HT','DENSITY','STKG'],                        'polygon',  '4.3.15',       R.findPDF('FIM_AR_TechSpec_2018.pdf#page=89')],

    "FTG":  ["Free-To-Grow",                            ['ARDSTGRP','YRDEP','DSTBFU','SGR','TARGETFU','FTG'],       'polygon',  '4.3.17',       R.findPDF('FIM_AR_TechSpec_2018.pdf#page=108')],

    "HRV":  ["Harvest Disturbance",                     ['BLOCKID','HARVCAT','SILVSYS','HARVMTHD','MGMTSTG',
                                                            'ESTAREA','SGR','DSTBFU','TARGETFU','TARGETYD','TRIAL',
                                                            'LOGMTHD'],                                             'polygon',  '4.3.8',        R.findPDF('FIM_AR_TechSpec_2018.pdf#page=31')],

    "NDB":  ["Natural Disturbance",                     ['NDEPCAT','VOLCON','VOLHWD','DSTBFU'],                     'polygon',  '4.3.7',        R.findPDF('FIM_AR_TechSpec_2018.pdf#page=27')],
    "PER":  ["Performance Assessment",                  ['SILVSYS','PERFU','PERYIELD','SPCOMP','BHA','HT',
                                                            'DENSITY','STKG','AGS','UGS'],                          'polygon',  '4.3.16',       R.findPDF('FIM_AR_TechSpec_2018.pdf#page=100')],

    "PRT":  ["Protection Treatment",                    ['TRTMTHD1','TRTCAT1'],                                     'polygon',  '4.3.14',       R.findPDF('FIM_AR_TechSpec_2018.pdf#page=83')],
    "RDS":  ["Road Construction and Road Use",          ['ROADID','ROADCLAS','CONSTRCT','DECOM','TRANS','ACCESS',
                                                            'MAINTAIN','MONITOR','CONTROL1','CONTROL2'],            'arc',      '4.3.9',        R.findPDF('FIM_AR_TechSpec_2018.pdf#page=46')],

    "RGN":  ["Regeneration Treatment",                  ['TRTMTHD1','TRTCAT1','ESTAREA','SP1','SP2'],               'polygon',  '4.3.11',       R.findPDF('FIM_AR_TechSpec_2018.pdf#page=61')],
    "SCT":  ["Slash and Chip Treatment",                ['SLASHPIL','CHIPPIL','BURN','MECHANIC','REMOVAL'],         'arc',      '4.3.20',       R.findPDF('FIM_AR_TechSpec_2018.pdf#page=124')],
    "SGR":  ["Silvicultural Ground Rule Update",        ['SGR','TARGETFU','TARGETYD','TRIAL'],                      'polygon',  '4.3.19',       R.findPDF('FIM_AR_TechSpec_2018.pdf#page=120')],
